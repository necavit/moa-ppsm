...
public class LaplacianNoiseGenerator {
	 ...
	 * 
	 * The general contract of nextDouble is that one double value, chosen (approximately) uniformly from the range 
	 * 0.0d (inclusive) to 1.0d (exclusive), is pseudorandomly generated and returned.
	 * 
	 ...
	 * bits, then the algorithm shown would choose double values from the stated range with perfect uniformity.
	 */
